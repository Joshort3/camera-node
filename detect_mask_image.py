...
def mask_image():
	...
	while True:
		...
		#detection counter for database
		mask_counter_with = 0
		mask_counter_without = 0
		...
		for i in range(0, detections.shape[2]):
			...
			if confidence > args["confidence"]:
				...
				# mask detection counter for database
				if mask > withoutMask:
					mask_counter_with = mask_counter_with + 1
				else:
					mask_counter_without = mask_counter_without + 1
